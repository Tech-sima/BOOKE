(function initCloudStorage(global) {
    ...
    const firebaseService = global.firebaseService;
    ...
    if (!app || !auth || !db || !FieldValue) {
        console.warn('[cloud-storage] Firebase dependencies are missing. Local storage will be used only.');
        return;
    }
